        ...
        <header class="stick style2 w-100">
            <div class="topbar bg-color1 d-flex flex-wrap justify-content-between w-100">
                ...
                <div class="topbar-right d-inline-flex">
                    <ul class="topbar-info-list mb-0 list-unstyled d-inline-flex">
                        <?php if (isset($jadwalsolat->data->jadwal->terbit)) : ?>
                            <li><i class="thm-clr flaticon-sun"></i>Sunrise At: <span class="thm-clr"><?php echo $jadwalsolat->data->jadwal->terbit ?> WITA</span></li>
                        <?php endif; ?>
                        <?php if (isset($jadwalsolat->data->jadwal->maghrib)) : ?>
                            <li><i class="thm-clr flaticon-moon"></i>Sunset At: <span class="thm-clr"><?php echo $jadwalsolat->data->jadwal->maghrib ?> WITA</span></li>
                        <?php endif; ?>
                    </ul>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12 col-sm-12 col-lg-4">
                            <div class="time-title w-100">
                                <?php if (isset($jadwalsolat->data->lokasi)) : ?>
                                    <h4 class="mb-0"><?php echo $jadwalsolat->data->lokasi ?></h4>
                                <?php else : ?>
                                    <h4 class="mb-0">Sleman, Yogyakarta</h4>
                                <?php endif; ?>
                        ...
                        <div class="col-md-12 col-sm-12 col-lg-8">
                            <ul class="time-list2 d-flex flex-wrap w-100 mb-0 list-unstyled">
                                <li><span>Subuh:</span><?php echo isset($jadwalsolat->data->jadwal->terbit) ? convertToWIB($jadwalsolat->data->jadwal->terbit, $timezoneSleman) : '04:19'; ?></li>
                                <li><span>Dhuhr:</span><?php echo isset($jadwalsolat->data->jadwal->dzuhur) ? convertToWIB($jadwalsolat->data->jadwal->dzuhur, $timezoneSleman) : '11:54'; ?></li>
                                <li><span>Asr:</span><?php echo isset($jadwalsolat->data->jadwal->ashar) ? convertToWIB($jadwalsolat->data->jadwal->ashar, $timezoneSleman) : '15:13'; ?></li>
                                <li><span>Maghrib:</span><?php echo isset($jadwalsolat->data->jadwal->maghrib) ? convertToWIB($jadwalsolat->data->jadwal->maghrib, $timezoneSleman) : '18:07'; ?></li>
                                <li><span>Isha'a:</span><?php echo isset($jadwalsolat->data->jadwal->isya) ? convertToWIB($jadwalsolat->data->jadwal->isya, $timezoneSleman) : '19:21'; ?></li>
                            </ul>
                        </div>
                    </div>
                </div><!-- Time Wrap -->
