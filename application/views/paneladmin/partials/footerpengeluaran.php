						...
						<div class="card-body">
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label>Head Account <span>*</span></label>

										<select id="ha" name="ha" class="select2 form-control" required="required">
											<option value="">Pilih Head Account</option>
											<?php 
											$data = $this->db->get('tbl_headaccount')->result();
											foreach ($data as $row) {
												echo '<option value="' .
													$row->id .
													'">' .
													$row->account_id.'-'.$row->head_account.
													'</option>';
											} ?>
										</select>
									</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select id="eha" name="eha" class="select2 form-control" required="required">
											<option value="">Pilih Head Account</option>
											<?php 
											$data = $this->db->get('tbl_headaccount')->result();
											foreach ($data as $row) {
