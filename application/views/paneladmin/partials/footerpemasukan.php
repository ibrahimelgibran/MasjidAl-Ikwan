							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select id="jenis" name="jenis" class="select2 form-control"
											required="required">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label>donatur <span>*</span></label>
										<input type="text" name="donatur" id="donatur" class="form-control select2">
									</div>
								</div>
								<!-- /.col -->
							</div>
							...
							<div class="row">
								<div class="col-md-6">
									...
									<div class="form-group">
										...
										<select id="ejenis" name="ejenis" class="select2 form-control"
											required="required">
								...
								<div class="col-md-6">
									...
									<div class="form-group">
										<label>donatur <span>*</span></label>
										<input type="text" name="edonatur" id="edonatur" class="form-control select2">
									</div>
									<!-- /.form-group -->
			...
			$.ajax({
				...
				success: function (data) {
					$.each(data, function (jumlah, tanggal, jenis, namajenis,
						...
						$('[name="edonatur"]').val(data.donatur);
