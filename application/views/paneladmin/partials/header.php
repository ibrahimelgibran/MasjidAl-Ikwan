...
<body class="hold-transition sidebar-mini  layout-fixed ">
    ...
    <img class="animation__shake" src="<?php echo base_url() ?>assets/images/fav.png" alt="AdminLTELogo" height="100" width="300">
		...
		<!-- Navbar -->
		<nav style="background: rgb(37,0,247);
				background: linear-gradient(90deg, rgba(37,0,247,1) 0%, rgba(6,82,106,0.9164040616246498) 82%, rgba(4,52,52,0.969625350140056) 100%);" class="main-header navbar navbar-expand navbar-primary navbar-dark border-bottom-0">
			<!-- Left navbar links -->
			<ul class="navbar-nav">
				<li class="nav-item">
