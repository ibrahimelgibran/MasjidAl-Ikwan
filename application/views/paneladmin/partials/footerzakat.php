	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Tambah Pemasukkan Zakat</h4>
...
<div class="modal fade" id="modal-edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Edit Pemasukkan Zakat</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
			...
			<form>
				<div class="modal-body">
					...
					<div class="alert alert-warning">
						<p>Apakah Anda Yakin akan <strong> Menghapus </strong> Pemasukan Zakat ini?</p>
	...
	$(document).ready(function () {
		...
		function tampildata() {
            ...
            $.extend( true, {}, buttonCommon, {
				...
				"ajax": {
					url: "<?php echo base_url()?>k_zakat/getdata",
					type: 'GET'
				},
		...
		$.validator.setDefaults({
			submitHandler: function (form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url() ?>k_zakat/simpan",
					data: formData,
					processData: false,
					contentType: false,
					cache: false,
		...
		$.validator.setDefaults({
			submitHandler: function (form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url() ?>k_zakat/simpanedit",
					data: formData,
					processData: false,
					contentType: false,
					cache: false,
		...
		$('#datazakat').on('click', '.bedit', function () {
			...
			$.ajax({
				type: "GET",
				url: "<?php echo base_url()?>k_zakat/showedit",
				dataType: "JSON",
				data: {
					id: id
				},
		...
		$('#btn_hapus').on('click', function () {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url()?>k_zakat/hapus",
				data: {
					id: kode
				},
				success: function (response) {
