...
<div class="modal fade" id="ModalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title" id="myModalLabel">Hapus Rencana Kegiatan</h4>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			...
			<form>
				<div class="modal-body">
					...
					<div class="alert alert-warning">
						<p>Apakah Anda Yakin akan <strong> Menghapus </strong> Rencana Kegiatan ini?</p>
...
$(document).ready(function () {
  ...
  /*/  var events = <?php echo json_encode($data) ?>;/*/
    ...
    var calendar = new Calendar(calendarEl, {
      ...
      events:"<?php echo base_url(); ?>k_calendar/load",
      contentHeight: 500,
    ...
    calendar.render();
		...
		function tampildata() {
			$('#datadistribusi').DataTable({
				...
				"buttons": [ "pdf", "print"],
				"ajax": {
					url: "<?php echo base_url()?>k_calendar/getdata",
					type: 'GET'
				},
			});
		...
		$.validator.setDefaults({
			submitHandler: function (form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url() ?>k_calendar/simpan",
					data: formData,
					processData: false,
					contentType: false,
					cache: false,
		...
		$.validator.setDefaults({
			submitHandler: function (form) {
				...
				$.ajax({
					type: "POST",
					url: "<?php echo base_url() ?>k_calendar/simpanedit",
					data: formData,
					processData: false,
					contentType: false,
					cache: false,
		...
		$('#datadistribusi').on('click', '.bedit', function () {
			...
			$.ajax({
				type: "GET",
				url: "<?php echo base_url()?>k_calendar/showedit",
				dataType: "JSON",
				data: {
					id: id
				},
		...
		$('#btn_hapus').on('click', function () {
			...
			$.ajax({
				type: "POST",
				url: "<?php echo base_url()?>k_calendar/hapus",
				data: {
					id: kode
				},
				success: function (response) {
