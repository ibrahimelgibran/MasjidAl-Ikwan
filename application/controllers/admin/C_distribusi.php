...
class C_distribusi extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['judul'] = 'Kelola Distribusi Zakat';

		$this->load->view('paneladmin/partials/header', $data);
		$this->load->view('paneladmin/partials/sidebar', $data);
		$this->load->view('paneladmin/v_distribusi', $data);
		$this->load->view('paneladmin/partials/footerdistribusi', $data);
	}
	...
	public function getdata()
	{
		...
		$query = $this->db->get("tbl_distribusizakat");

        // widget
        $tahunini = date('Y');
		$totalzakatuang = $this->db->query(" SELECT SUM(nilai_uang) AS total FROM tbl_distribusizakat ")->row();
        $totalzakatuangtahunini= $this->db->query("SELECT SUM(nilai_uang) AS total FROM tbl_distribusizakat WHERE YEAR(tanggal_diterima) = '$tahunini'")->row();

        $totalzakatberas= $this->db->query(" SELECT SUM(nilai_beras) AS total FROM tbl_distribusizakat ")->row();
        $totalzakatberastahunini= $this->db->query("SELECT SUM(nilai_beras) AS total FROM tbl_distribusizakat WHERE YEAR(tanggal_diterima) = '$tahunini'")->row();
		...
		$result = array(
            ...
            'totaluang'    =>  '
                   <div class="info-box bg-light ">
                     ...
                     <div class="info-box-content">
                       <span class="info-box-text"> Total Distribusi Zakat Uang  :</span>
			...
			'totaluangtahun'    =>  '
                   <div class="info-box bg-light ">
                     ...
                     <div class="info-box-content">
                       <span class="info-box-text">Distribusi Zakat Uang Tahun ini :</span>
                   ...
                   <div class="info-box bg-light ">
                     ...
                     <div class="info-box-content">
                       <span class="info-box-text"> Total Distribusi Zakat beras  :</span>
			...
			'totalberastahun'    =>  '
                   <div class="info-box bg-light ">
                     ...
                     <div class="info-box-content">
                       <span class="info-box-text">Distribusi Zakat Beras Tahun ini :</span>
	...
	function simpan()
	{
		...
		$keterangan = $this->input->post('keterangan');
            ...
            $data = $this->db->insert('tbl_distribusizakat', $datasimpan);
            if ($data) {
                echo 'success';
            } else {
                echo 'error';
	...
	public function showedit()
	{
		...
		$user = $this->db->get_where("tbl_distribusizakat",["id" => $koser]);
		if ($user->num_rows() > 0) {
			foreach ($user->result() as $data) {
				$hasil = array(
                    'tahun' => $data->tahun,
                    'mustahiq' => $data->mustahiq,
                    'jenis' => $data->jenis,
	...
	public function simpanedit()
	{
		...
		$mustahiq = $this->input->post('emustahiq');
		...
		$simpan = $this->db->update('tbl_distribusizakat', $datasimpan);
		if ($simpan) {
			echo 'success';
		} else {
			echo 'error';
	...
	public function hapus()
	{
		...
		$data = $this->db->query("DELETE FROM tbl_distribusizakat WHERE id = '$id' ");
		if ($data) {
			echo 'success';
		} else {
			echo 'error';
