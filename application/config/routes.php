...
// headaccount
$route['k_headaccount/(:any)'] = 'admin/c_headaccount/$1';
// jamaah
$route['k_jamaah/(:any)'] = 'admin/c_jamaah/$1';
// zakat
$route['k_zakat/(:any)'] = 'admin/c_zakat/$1';
// distribusizakat
$route['k_distribusizakat/(:any)'] = 'admin/c_distribusi/$1';

// qurban
$route['k_qurban/(:any)'] = 'admin/c_qurban/$1';
// kalender
$route['k_calendar/(:any)'] = 'admin/c_calendar/$1';
// aset
$route['k_aset/(:any)'] = 'admin/c_aset/$1';
